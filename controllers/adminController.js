...
// (Opsional) Buat admin pertama kali
...
// 2. Admin Dashboard (Melihat semua data user + status API)
exports.getDashboardData = async (req, res) => {
  try {
    ...
    // Proses data untuk menambahkan status valid/invalid
...
// 3. Admin Edit API Key
exports.updateApiKey = async (req, res) => {
  const { id } = req.params; // id dari ApiKey
